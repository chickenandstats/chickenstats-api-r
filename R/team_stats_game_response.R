#' Create a new TeamStatsGameResponse
#'
#' @description
#' TeamStatsGameResponse Class
#'
#' @docType class
#' @title TeamStatsGameResponse
#' @description TeamStatsGameResponse Class
...
#' @field data  list(\link{TeamStatsGame})
#' @importFrom R6 R6Class
#' @importFrom jsonlite fromJSON toJSON
#' @export
TeamStatsGameResponse <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Initialize a new TeamStatsGameResponse class.
    #'
    #' @param count count
    #' @param total total
    #' @param limit limit
    ...
    #'
    #' @return TeamStatsGameResponse as a base R list.
    #' @examples
    #' # convert array of TeamStatsGameResponse (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert TeamStatsGameResponse to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      TeamStatsGameResponseObject <- list()
      if (!is.null(self$`count`)) {
        TeamStatsGameResponseObject[["count"]] <-
          self$`count`
      }
      if (!is.null(self$`total`)) {
        TeamStatsGameResponseObject[["total"]] <-
          self$`total`
      }
      if (!is.null(self$`limit`)) {
        TeamStatsGameResponseObject[["limit"]] <-
          self$`limit`
      }
      if (!is.null(self$`offset`)) {
        TeamStatsGameResponseObject[["offset"]] <-
          self$`offset`
      }
      if (!is.null(self$`has_next`)) {
        TeamStatsGameResponseObject[["has_next"]] <-
          self$`has_next`
      }
      if (!is.null(self$`data`)) {
        TeamStatsGameResponseObject[["data"]] <-
          lapply(self$`data`, function(x) x$toSimpleType())
      }
      return(TeamStatsGameResponseObject)
    },

    #' @description
    #' Deserialize JSON string into an instance of TeamStatsGameResponse
    #'
    #' @param input_json the JSON input
    #' @return the instance of TeamStatsGameResponse
    fromJSON = function(input_json) {
      ...
      if (!is.null(this_object$`data`)) {
        self$`data` <- ApiClient$new()$deserializeObj(this_object$`data`, "array[TeamStatsGame]", loadNamespace("chickenstats.api"))
      }
      self
    },
    ...
    #' @return TeamStatsGameResponse in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to TeamStatsGameResponse and throw an exception if invalid
    #'
    ...
    validateJSON = function(input) {
      ...
      if (!is.null(input_json$`count`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for TeamStatsGameResponse: the required field `count` is missing."))
      }
      ...
      if (!is.null(input_json$`total`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for TeamStatsGameResponse: the required field `total` is missing."))
      }
      ...
      if (!is.null(input_json$`limit`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for TeamStatsGameResponse: the required field `limit` is missing."))
      }
      ...
      if (!is.null(input_json$`offset`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for TeamStatsGameResponse: the required field `offset` is missing."))
      }
      ...
      if (!is.null(input_json$`has_next`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for TeamStatsGameResponse: the required field `has_next` is missing."))
      }
      ...
      if (!is.null(input_json$`data`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for TeamStatsGameResponse: the required field `data` is missing."))
      }
    },
    ...
    #'
    #' @return String representation of TeamStatsGameResponse
    toString = function() {
      self$toJSONString()
    },
...
# TeamStatsGameResponse$unlock()
#
## Below is an example to define the print function
# TeamStatsGameResponse$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# TeamStatsGameResponse$lock()
