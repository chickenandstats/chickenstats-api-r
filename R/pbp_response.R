...
#' @field data  list(\link{PbpPublic})
#' @importFrom R6 R6Class
#' @importFrom jsonlite fromJSON toJSON
#' @export
PbpResponse <- R6::R6Class(
  "PbpResponse",
  public = list(
    `count` = NULL,
    `total` = NULL,
    ...
    #' @description
    #' Initialize a new PbpResponse class.
    #'
    #' @param count count
    #' @param total total
    #' @param limit limit
    ...
    #'
    #' @return PbpResponse as a base R list.
    #' @examples
    #' # convert array of PbpResponse (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert PbpResponse to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      PbpResponseObject <- list()
      if (!is.null(self$`count`)) {
        PbpResponseObject[["count"]] <-
          self$`count`
      }
      if (!is.null(self$`total`)) {
        PbpResponseObject[["total"]] <-
          self$`total`
      }
      if (!is.null(self$`limit`)) {
        PbpResponseObject[["limit"]] <-
          self$`limit`
      }
      if (!is.null(self$`offset`)) {
        PbpResponseObject[["offset"]] <-
          self$`offset`
      }
      if (!is.null(self$`has_next`)) {
        PbpResponseObject[["has_next"]] <-
          self$`has_next`
      }
      if (!is.null(self$`data`)) {
        PbpResponseObject[["data"]] <-
          lapply(self$`data`, function(x) x$toSimpleType())
      }
      return(PbpResponseObject)
    },

    #' @description
    #' Deserialize JSON string into an instance of PbpResponse
    #'
    #' @param input_json the JSON input
    #' @return the instance of PbpResponse
    fromJSON = function(input_json) {
      ...
      if (!is.null(this_object$`data`)) {
        self$`data` <- ApiClient$new()$deserializeObj(this_object$`data`, "array[PbpPublic]", loadNamespace("chickenstats.api"))
      }
      self
    },
    ...
    #' @return PbpResponse in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to PbpResponse and throw an exception if invalid
    #'
    ...
    validateJSON = function(input) {
      ...
      if (!is.null(input_json$`count`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for PbpResponse: the required field `count` is missing."))
      }
      ...
      if (!is.null(input_json$`total`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for PbpResponse: the required field `total` is missing."))
      }
      ...
      if (!is.null(input_json$`limit`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for PbpResponse: the required field `limit` is missing."))
      }
      ...
      if (!is.null(input_json$`offset`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for PbpResponse: the required field `offset` is missing."))
      }
      ...
      if (!is.null(input_json$`has_next`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for PbpResponse: the required field `has_next` is missing."))
      }
      ...
      if (!is.null(input_json$`data`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for PbpResponse: the required field `data` is missing."))
      }
    },
    ...
    #'
    #' @return String representation of PbpResponse
    toString = function() {
      self$toJSONString()
    },
...
# PbpResponse$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
