#' Create a new StatsSeasonResponse
#'
#' @description
#' StatsSeasonResponse Class
#'
#' @docType class
#' @title StatsSeasonResponse
#' @description StatsSeasonResponse Class
...
#' @field data  list(\link{StatsSeason})
#' @importFrom R6 R6Class
#' @importFrom jsonlite fromJSON toJSON
#' @export
StatsSeasonResponse <- R6::R6Class(
  "StatsSeasonResponse",
  public = list(
    `count` = NULL,
    `total` = NULL,
    ...
    #' @description
    #' Initialize a new StatsSeasonResponse class.
    #'
    #' @param count count
    #' @param total total
    #' @param limit limit
    ...
    #'
    #' @return StatsSeasonResponse as a base R list.
    #' @examples
    #' # convert array of StatsSeasonResponse (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert StatsSeasonResponse to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      StatsSeasonResponseObject <- list()
      if (!is.null(self$`count`)) {
        StatsSeasonResponseObject[["count"]] <-
          self$`count`
      }
      if (!is.null(self$`total`)) {
        StatsSeasonResponseObject[["total"]] <-
          self$`total`
      }
      if (!is.null(self$`limit`)) {
        StatsSeasonResponseObject[["limit"]] <-
          self$`limit`
      }
      if (!is.null(self$`offset`)) {
        StatsSeasonResponseObject[["offset"]] <-
          self$`offset`
      }
      if (!is.null(self$`has_next`)) {
        StatsSeasonResponseObject[["has_next"]] <-
          self$`has_next`
      }
      if (!is.null(self$`data`)) {
        StatsSeasonResponseObject[["data"]] <-
          lapply(self$`data`, function(x) x$toSimpleType())
      }
      return(StatsSeasonResponseObject)
    },

    #' @description
    #' Deserialize JSON string into an instance of StatsSeasonResponse
    #'
    #' @param input_json the JSON input
    #' @return the instance of StatsSeasonResponse
    fromJSON = function(input_json) {
      ...
      if (!is.null(this_object$`data`)) {
        self$`data` <- ApiClient$new()$deserializeObj(this_object$`data`, "array[StatsSeason]", loadNamespace("chickenstats.api"))
      }
      self
    },
    ...
    #' @return StatsSeasonResponse in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to StatsSeasonResponse and throw an exception if invalid
    #'
    ...
    validateJSON = function(input) {
      ...
      if (!is.null(input_json$`count`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for StatsSeasonResponse: the required field `count` is missing."))
      }
      ...
      if (!is.null(input_json$`total`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for StatsSeasonResponse: the required field `total` is missing."))
      }
      ...
      if (!is.null(input_json$`limit`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for StatsSeasonResponse: the required field `limit` is missing."))
      }
      ...
      if (!is.null(input_json$`offset`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for StatsSeasonResponse: the required field `offset` is missing."))
      }
      ...
      if (!is.null(input_json$`has_next`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for StatsSeasonResponse: the required field `has_next` is missing."))
      }
      ...
      if (!is.null(input_json$`data`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for StatsSeasonResponse: the required field `data` is missing."))
      }
    },
    ...
    #'
    #' @return String representation of StatsSeasonResponse
    toString = function() {
      self$toJSONString()
    },
...
# StatsSeasonResponse$unlock()
#
## Below is an example to define the print function
# StatsSeasonResponse$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# StatsSeasonResponse$lock()
