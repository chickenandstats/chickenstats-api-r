#' Create a new LinesGameResponse
#'
#' @description
#' LinesGameResponse Class
#'
#' @docType class
#' @title LinesGameResponse
#' @description LinesGameResponse Class
...
#' @field data  list(\link{LinesGame})
#' @importFrom R6 R6Class
#' @importFrom jsonlite fromJSON toJSON
#' @export
LinesGameResponse <- R6::R6Class(
  "LinesGameResponse",
  public = list(
    `count` = NULL,
    `total` = NULL,
    ...
    #' @description
    #' Initialize a new LinesGameResponse class.
    #'
    #' @param count count
    #' @param total total
    #' @param limit limit
    ...
    #'
    #' @return LinesGameResponse as a base R list.
    #' @examples
    #' # convert array of LinesGameResponse (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert LinesGameResponse to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      LinesGameResponseObject <- list()
      if (!is.null(self$`count`)) {
        LinesGameResponseObject[["count"]] <-
          self$`count`
      }
      if (!is.null(self$`total`)) {
        LinesGameResponseObject[["total"]] <-
          self$`total`
      }
      if (!is.null(self$`limit`)) {
        LinesGameResponseObject[["limit"]] <-
          self$`limit`
      }
      if (!is.null(self$`offset`)) {
        LinesGameResponseObject[["offset"]] <-
          self$`offset`
      }
      if (!is.null(self$`has_next`)) {
        LinesGameResponseObject[["has_next"]] <-
          self$`has_next`
      }
      if (!is.null(self$`data`)) {
        LinesGameResponseObject[["data"]] <-
          lapply(self$`data`, function(x) x$toSimpleType())
      }
      return(LinesGameResponseObject)
    },

    #' @description
    #' Deserialize JSON string into an instance of LinesGameResponse
    #'
    #' @param input_json the JSON input
    #' @return the instance of LinesGameResponse
    fromJSON = function(input_json) {
      ...
      if (!is.null(this_object$`data`)) {
        self$`data` <- ApiClient$new()$deserializeObj(this_object$`data`, "array[LinesGame]", loadNamespace("chickenstats.api"))
      }
      self
    },
    ...
    #' @return LinesGameResponse in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to LinesGameResponse and throw an exception if invalid
    #'
    ...
    validateJSON = function(input) {
      ...
      if (!is.null(input_json$`count`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for LinesGameResponse: the required field `count` is missing."))
      }
      ...
      if (!is.null(input_json$`total`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for LinesGameResponse: the required field `total` is missing."))
      }
      ...
      if (!is.null(input_json$`limit`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for LinesGameResponse: the required field `limit` is missing."))
      }
      ...
      if (!is.null(input_json$`offset`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for LinesGameResponse: the required field `offset` is missing."))
      }
      ...
      if (!is.null(input_json$`has_next`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for LinesGameResponse: the required field `has_next` is missing."))
      }
      ...
      if (!is.null(input_json$`data`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for LinesGameResponse: the required field `data` is missing."))
      }
    },
    ...
    #'
    #' @return String representation of LinesGameResponse
    toString = function() {
      self$toJSONString()
    },
...
# LinesGameResponse$unlock()
#
## Below is an example to define the print function
# LinesGameResponse$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# LinesGameResponse$lock()
