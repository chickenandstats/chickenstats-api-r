#' Create a new LinesSeasonResponse
#'
#' @description
#' LinesSeasonResponse Class
#'
#' @docType class
#' @title LinesSeasonResponse
#' @description LinesSeasonResponse Class
...
#' @field data  list(\link{LinesSeason})
#' @importFrom R6 R6Class
#' @importFrom jsonlite fromJSON toJSON
#' @export
LinesSeasonResponse <- R6::R6Class(
  "LinesSeasonResponse",
  public = list(
    `count` = NULL,
    `total` = NULL,
    ...
    #' @description
    #' Initialize a new LinesSeasonResponse class.
    #'
    #' @param count count
    #' @param total total
    #' @param limit limit
    ...
    #'
    #' @return LinesSeasonResponse as a base R list.
    #' @examples
    #' # convert array of LinesSeasonResponse (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert LinesSeasonResponse to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      LinesSeasonResponseObject <- list()
      if (!is.null(self$`count`)) {
        LinesSeasonResponseObject[["count"]] <-
          self$`count`
      }
      if (!is.null(self$`total`)) {
        LinesSeasonResponseObject[["total"]] <-
          self$`total`
      }
      if (!is.null(self$`limit`)) {
        LinesSeasonResponseObject[["limit"]] <-
          self$`limit`
      }
      if (!is.null(self$`offset`)) {
        LinesSeasonResponseObject[["offset"]] <-
          self$`offset`
      }
      if (!is.null(self$`has_next`)) {
        LinesSeasonResponseObject[["has_next"]] <-
          self$`has_next`
      }
      if (!is.null(self$`data`)) {
        LinesSeasonResponseObject[["data"]] <-
          lapply(self$`data`, function(x) x$toSimpleType())
      }
      return(LinesSeasonResponseObject)
    },

    #' @description
    #' Deserialize JSON string into an instance of LinesSeasonResponse
    #'
    #' @param input_json the JSON input
    #' @return the instance of LinesSeasonResponse
    fromJSON = function(input_json) {
      ...
      if (!is.null(this_object$`data`)) {
        self$`data` <- ApiClient$new()$deserializeObj(this_object$`data`, "array[LinesSeason]", loadNamespace("chickenstats.api"))
      }
      self
    },
    ...
    #' @return LinesSeasonResponse in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to LinesSeasonResponse and throw an exception if invalid
    #'
    ...
    validateJSON = function(input) {
      ...
      if (!is.null(input_json$`count`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for LinesSeasonResponse: the required field `count` is missing."))
      }
      ...
      if (!is.null(input_json$`total`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for LinesSeasonResponse: the required field `total` is missing."))
      }
      ...
      if (!is.null(input_json$`limit`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for LinesSeasonResponse: the required field `limit` is missing."))
      }
      ...
      if (!is.null(input_json$`offset`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for LinesSeasonResponse: the required field `offset` is missing."))
      }
      ...
      if (!is.null(input_json$`has_next`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for LinesSeasonResponse: the required field `has_next` is missing."))
      }
      ...
      if (!is.null(input_json$`data`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for LinesSeasonResponse: the required field `data` is missing."))
      }
    },
    ...
    #'
    #' @return String representation of LinesSeasonResponse
    toString = function() {
      self$toJSONString()
    },
...
# LinesSeasonResponse$unlock()
#
## Below is an example to define the print function
# LinesSeasonResponse$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# LinesSeasonResponse$lock()
